...
import com.healthy.healthyaging.R;
...
//        ExampleApplication.livenessList.add(LivenessTypeEnum.HeadLeftOrRight);
        ...
        requestPermissions(99, mPermissions);
...
//        setFaceConfig();
            ...
            try {
                if (Build.VERSION.SDK_INT >= 23) {
                    ...
                    for (String pms:permission) {
                        int hasPer = checkSelfPermission(pms);
                        if (hasPer != PackageManager.PERMISSION_GRANTED) {
                            // 是否应该显示权限请求
                            boolean isShould = shouldShowRequestPermissionRationale(pms);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (!flag) {
            requestPermissions(99, permissions);
        }
    }
